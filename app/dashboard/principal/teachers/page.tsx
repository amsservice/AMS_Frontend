...
import { useState } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { Users, Plus, X, Mail, BookOpen, Trash2, Edit, UserX, Eye, Phone, Calendar, MapPin, User } from 'lucide-react';
...
export default function TeachersPage() {
  ...
  const stats = [
    { label: 'Total Teachers', value: teachers.length, bgGradient: 'from-blue-500 to-indigo-600' },
    { label: 'Active', value: teachers.filter((t: Teacher) => t.isActive).length, bgGradient: 'from-green-500 to-emerald-600' },
    { label: 'Inactive', value: teachers.filter((t: Teacher) => !t.isActive).length, bgGradient: 'from-orange-500 to-amber-600' },
    { label: 'Assigned', value: teachers.filter((t: Teacher) => t.currentClass).length, bgGradient: 'from-purple-500 to-violet-600' }
  ];
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-xl rounded-2xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
            ...
            <div className="hidden lg:grid lg:grid-cols-12 gap-4 px-6 py-3 border-b border-gray-200/50 dark:border-gray-700/50 bg-gray-50/50 dark:bg-gray-700/50">
              ...
              <div className="col-span-3 text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Email</div>
              <div className="col-span-2 text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Assigned Class</div>
              <div className="col-span-1 text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Status</div>
              <div className="col-span-3 text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide text-right">Actions</div>
            </div>
                  ...
                  <div key={teacher.id} className="p-4 sm:p-5 lg:px-6 hover:bg-gray-50/50 dark:hover:bg-gray-700/50 transition-colors">
                    <div className="lg:hidden space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1 flex-wrap">
                            <h3 className="font-semibold text-gray-900 dark:text-white">{teacher.name}</h3>
                            <Badge className={`${teacher.isActive ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400 border-green-200 dark:border-green-800' : 'bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-400 border-gray-200 dark:border-gray-700'} border`}>
                      ...
                      <div className="flex gap-2 flex-wrap">
                        ...
                        {teacher.isActive ? (
                          <button onClick={() => deactivateTeacher(teacher.id)} className="bg-orange-500 hover:bg-orange-600 text-white font-semibold py-2 px-4 rounded-xl transition-all text-sm flex items-center gap-2 shadow-sm">
                            <UserX className="w-4 h-4" />
                          </button>
                        ) : (
                          <button onClick={() => deleteTeacher(teacher.id)} className="bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded-xl transition-all text-sm flex items-center gap-2 shadow-sm">
                            <Trash2 className="w-4 h-4" />
                          </button>
                        )}
                      </div>
                    ...
                    <div className="hidden lg:grid lg:grid-cols-12 gap-4 items-center">
                      ...
                      <div className="col-span-3 flex gap-2 justify-end">
                        ...
                        {teacher.isActive ? (
                          <button onClick={() => deactivateTeacher(teacher.id)} className="bg-orange-500 hover:bg-orange-600 text-white font-semibold py-2 px-4 rounded-xl transition-all text-sm flex items-center gap-2 shadow-sm" title="Deactivate">
                            <UserX className="w-5 h-5" />
                          </button>
                        ) : (
                          <button onClick={() => deleteTeacher(teacher.id)} className="bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded-xl transition-all text-sm flex items-center gap-2 shadow-sm" title="Delete">
                            <Trash2 className="w-5 h-5" />
                          </button>
                        )}
                      </div>
                  ...
                  <div className="sticky top-0 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-700 dark:from-blue-800 dark:via-purple-800 dark:to-indigo-900 px-6 py-4 rounded-t-2xl">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h2 className="text-xl font-bold text-white">{teacherFullData.data.name}</h2>
                          <Badge className={`mt-1 ${teacherFullData.data.isActive ? 'bg-green-100 text-green-700 border-green-200' : 'bg-gray-100 text-gray-700 border-gray-200'} border`}>
